        ...
        for product in products:
            try:
                ...
                sku_defaults = {
                    ...
                    'provider_name': product['providerNameList'][0] if product['providerNameList'] else '',
                    'unit_price': float(product['prop5']) if product['prop5'] else 0,
                    'weight': float(product['weight']) if product['weight'] else 0,
                    'material': product['prop8'] or '',
                    'plating_process': 'other',
                    'status': True,
                    'spu': spu,
